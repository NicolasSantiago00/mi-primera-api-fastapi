...
def verificar_setup():
    ...
    if venv:
        ...
        print("⚠  Entorno virtual no detectado")
    ...
    try:
        import fastapi
        print(f"✅ FastAPI instalado: v{fastapi._version_}")
    except ImportError:
    ...
    try:
        import uvicorn
        print(f"✅ Uvicorn instalado: v{uvicorn._version_}")
    except ImportError:
    ...
    try:
        ...
        print("⚠  Git no configurado localmente")
